...
${OBJECTDIR}/check.o: check.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/check.o check.cpp

${OBJECTDIR}/eval.o: eval.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eval.o eval.cpp
...
${TESTDIR}/tests/boardtestclass.o: tests/boardtestclass.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/boardtestclass.o tests/boardtestclass.cpp
...
${TESTDIR}/tests/evaltestclass.o: tests/evaltestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/evaltestclass.o tests/evaltestclass.cpp
...
${TESTDIR}/tests/hashtestrunner.o: tests/hashtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/hashtestrunner.o tests/hashtestrunner.cpp
...
${OBJECTDIR}/action_nomain.o: ${OBJECTDIR}/action.o action.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/action_nomain.o action.cpp;\
	else  \
...
${OBJECTDIR}/board_nomain.o: ${OBJECTDIR}/board.o board.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/board_nomain.o board.cpp;\
	else  \
...
${OBJECTDIR}/check_nomain.o: ${OBJECTDIR}/check.o check.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/check_nomain.o check.cpp;\
	else  \
...
${OBJECTDIR}/eval_nomain.o: ${OBJECTDIR}/eval.o eval.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eval_nomain.o eval.cpp;\
	else  \
...
${OBJECTDIR}/hash_nomain.o: ${OBJECTDIR}/hash.o hash.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hash_nomain.o hash.cpp;\
	else  \
...
${OBJECTDIR}/init_nomain.o: ${OBJECTDIR}/init.o init.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/init_nomain.o init.cpp;\
	else  \
...
${OBJECTDIR}/play_nomain.o: ${OBJECTDIR}/play.o play.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/play_nomain.o play.cpp;\
	else  \
...
${OBJECTDIR}/search_nomain.o: ${OBJECTDIR}/search.o search.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/search_nomain.o search.cpp;\
	else  \
