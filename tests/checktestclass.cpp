...
void checktestclass::testIs_check() {
    ...
    board _board2 ( pb, castling, 0, 0, 3, black, 200 );
    ...
    board _board3 ( pb, castling, 0, 0, 3, black, 200 );
    ...
    board _board4 ( pb, castling, 0, 0, 3, black, 200 );
    ...
    board _board5 ( pb, castling, 0, 0, 3, white, 200 );
